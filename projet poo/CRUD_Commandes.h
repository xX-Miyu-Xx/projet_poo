...
namespace CRUD_Commandes {
	...
	{
	public:
		CRUD_Commandes(Utilisateur^ user, Dictionary<String^, System::Windows::Forms::Form^>^% Ptr_Pages)
		{
			InitializeComponent();
			utilisateur = user;
			Pages = Ptr_Pages;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &CRUD_Commandes::dataGridView1_CellContentClick_2);
			// 
			// ID_Personnel
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &CRUD_Commandes::button3_Click_1);
			// 
			// button4
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &CRUD_Commandes::label1_Click);
			// 
			// CRUD_Commandes
			// 
