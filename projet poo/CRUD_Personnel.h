...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// id_personnel
			// 
			this->id_personnel->Location = System::Drawing::Point(384, 140);
			...
			// prenom_personnel
			// 
			this->prenom_personnel->Location = System::Drawing::Point(384, 219);
			this->prenom_personnel->Margin = System::Windows::Forms::Padding(6);
			this->prenom_personnel->Name = L"prenom_personnel";
			this->prenom_personnel->Size = System::Drawing::Size(610, 31);
			this->prenom_personnel->TabIndex = 7;
			// 
			// id_sup_hier
			// 
			this->id_sup_hier->Location = System::Drawing::Point(384, 598);
			this->id_sup_hier->Margin = System::Windows::Forms::Padding(6);
			this->id_sup_hier->Name = L"id_sup_hier";
			this->id_sup_hier->Size = System::Drawing::Size(610, 31);
			this->id_sup_hier->TabIndex = 12;
			// 
			// adresse_personnel
			// 
			this->adresse_personnel->Location = System::Drawing::Point(384, 450);
			this->adresse_personnel->Margin = System::Windows::Forms::Padding(6);
			this->adresse_personnel->Name = L"adresse_personnel";
			this->adresse_personnel->Size = System::Drawing::Size(610, 31);
			this->adresse_personnel->TabIndex = 10;
			// 
			// age_personnel
			// 
			this->age_personnel->Location = System::Drawing::Point(384, 375);
			this->age_personnel->Margin = System::Windows::Forms::Padding(6);
			this->age_personnel->Name = L"age_personnel";
			this->age_personnel->Size = System::Drawing::Size(610, 31);
			this->age_personnel->TabIndex = 9;
			// 
			// nom_personnel
			// 
			this->nom_personnel->Location = System::Drawing::Point(384, 296);
			this->nom_personnel->Margin = System::Windows::Forms::Padding(6);
			this->nom_personnel->Name = L"nom_personnel";
			this->nom_personnel->Size = System::Drawing::Size(610, 31);
			...
			this->label8->Location = System::Drawing::Point(382, 494);
			...
			// date_embauche
			// 
			this->date_embauche->Location = System::Drawing::Point(386, 525);
			this->date_embauche->Margin = System::Windows::Forms::Padding(6);
			this->date_embauche->Name = L"date_embauche";
			this->date_embauche->Size = System::Drawing::Size(610, 31);
			...
			this->label9->Location = System::Drawing::Point(380, 110);
			...
			this->label7->Location = System::Drawing::Point(380, 188);
			...
			this->label6->Location = System::Drawing::Point(380, 265);
			...
			this->label5->Location = System::Drawing::Point(380, 344);
			...
			this->label4->Location = System::Drawing::Point(380, 419);
			...
			this->label3->Location = System::Drawing::Point(380, 567);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(90, 610);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(90, 429);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(90, 335);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(90, 246);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(90, 152);
			...
			this->button1->Location = System::Drawing::Point(90, 60);
