...
namespace CRUD_Personnel {
	...
	{
	public:
		CRUD_Personnel(Utilisateur^ user, Dictionary<String^, System::Windows::Forms::Form^>^% Ptr_Pages)
		{
			InitializeComponent();
			utilisateur = user;
			Pages = Ptr_Pages;
	...
	private: Utilisateur^ utilisateur; // Store the Utilisateur^ locally in MyForm
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(1) { this->ID_Personnel });
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &CRUD_Personnel::dataGridView1_CellContentClick_2);
			// 
			// ID_Personnel
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &CRUD_Personnel::button3_Click_1);
			// 
			// button4
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &CRUD_Personnel::label1_Click);
			// 
			// CRUD_Personnel
			// 
...
#pragma endregion
	...
	private: System::Void button3_Click_1(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Pages->ContainsKey("CRUD_Client")) {
			...
			System::Windows::Forms::Form^ crudClientsForm = Pages["CRUD_Client"];

			// Changer l'onglet vers l'instance de CRUD_Client
			if (crudClientsForm != nullptr) {
